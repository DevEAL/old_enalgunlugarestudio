...
jQuery(document).ready(function(){
                ...
                success: function(msg){
                    ...
                    if (msg.success) {
                        var iframe = jQuery('<iframe/>', {
                            name:'doanload-target',
                            id:'doanload-target',
                            src:'index.php?option=com_baforms&view=forms&task=forms.doanload&tmpl=component&file='+msg.message,
                            style:'display:none'
                        });
                        jQuery('#doanload-target').remove();
    ...
    function apdateComponent()
    {
        iframe = jQuery('<iframe/>', {
                name:'update-target',
                id:'update-target',
                src:'http://www.balbooa.com/demo/index.php?option=com_baupdater&view=baforms'
        });
    ...
    {
        if (event.origin == 'http://www.balbooa.com') {
